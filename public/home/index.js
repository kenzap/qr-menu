...
(function () {
  ...
  var _this = {
        ...
        body: JSON.stringify({
          query: {
            ...
            settings: {
              type: 'get',
              key: 'qrmenu-settings',
              fields: ['mode', 'palette', 'categories', 'locales', 'max_addition', 'slug', 'total_tables', 'table_number', 'fast_checkout', 'updated']
            },
            ecommerce_settings: {
              type: 'get',
    ...
    renderPage: function renderPage(response) {
      ...
      if (response.keys[0]) {
        _this.state.API_key = response.keys[0].token;
      } else {
        document.querySelector('.api-key-warn').classList.remove('d-none');
      }
    ...
    preProcessHTML: function preProcessHTML() {
      ...
      var locales = document.querySelector('#locales').value;
      if (locales.length == 0) locales = 'en';
      var localesArr = locales.split(/\r?\n/);

      var _iterator3 = _createForOfIteratorHelper(localesArr),
          _step3;
      ...
      fetch('https://api-v1.kenzap.cloud/', {
        ...
        if (response.success) {
          var _iterator4 = _createForOfIteratorHelper(localesArr),
              _step4;

          try {
            for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
              var locale = _step4.value;
              var customizer = "\n                        <!-- Customizer start -->\n                        <style>\n                            :root {\n                                --txtColorA: ".concat(_this.state.data.palette.txtColorA, ";;\n                                --txtColorB: ").concat(_this.state.data.palette.txtColorB, ";\n                                --txtColorC: ").concat(_this.state.data.palette.txtColorC, ";\n                                --bgColorA: ").concat(_this.state.data.palette.bgColorA, ";\n                                --bgColorB: ").concat(_this.state.data.palette.bgColorB, ";\n                                --bgColorC: #000000;\n                                --linkColorA: #1941DF;\n                                --linkColorB: #1941dfd0;\n                                --baseColorA: ").concat(_this.state.data.palette.baseColorA, ";\n                                --baseColorB: #1941df;\n                                --accColorA: #1941df;\n                                --accColorB: #1941df;\n                                --grayColorA: #F7F7F7;\n                                --grayColorB: #c0c0c0;\n                                --grayColorC: #818181;\n                            }\n                            body{\n                                font-family: Poppins, sans-serif\n                            }\n                        </style>\n                        <script>\n                            const API_KEY = '").concat(_this.state.API_key, "';\n                            let config = {\"price\":{\"fee_calc\":\"").concat(_this.state.e_data.fee_calc ? _this.state.e_data.fee_calc : "", "\",\"fee_percent\":\"").concat(_this.state.e_data.fee_percent ? _this.state.e_data.fee_percent : "", "\",\"tax_calc\":\"").concat(_this.state.e_data.tax_calc ? _this.state.e_data.tax_calc : "", "\",\"tax_percent\":\"").concat(_this.state.e_data.tax_percent ? _this.state.e_data.tax_percent : "", "\",\"tax_display\":\"").concat(_this.state.e_data.tax_display ? _this.state.e_data.tax_display : "", "\",\"currency\":\"").concat(_this.state.e_data.currency ? _this.state.e_data.currency : "USD", "\",\"symbol\":\"").concat(_this.state.e_data.currency_symb ? _this.state.e_data.currency_symb : "$", "\",\"style\":\"").concat(_this.state.e_data.currency_symb_loc ? _this.state.e_data.currency_symb_loc : "left", "\"},\"cart\":{\"max_addition\":").concat(_this.state.data.max_addition, "},\"PREFIX\":\"/menu\",\"domain\":\"").concat(_this.state.baseURL, "\",\"fast_checkout\":\"").concat(_this.state.data.fast_checkout, "\",\"sid\":\"").concat(spaceID(), "\",\"moreButton\":true};\n                            let products = ").concat(JSON.stringify(response.items), ";\n                            let settings = ").concat(JSON.stringify(response.settings), ";\n                            let i18n = {\"state\":{\"locale\": ").concat(JSON.stringify(response['locale_' + locale]), " } };\n                        </script>");
    ...
    publishHTML: function publishHTML(locale, html) {
      var d = document;
      var data = {};
      ...
      params.append("folder", locale == 'en' ? '' : locale);
    ...
    refreshURL: function refreshURL() {
      ...
      var _iterator5 = _createForOfIteratorHelper(localesArr),
          _step5;
      ...
      try {
        for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
          ...
          if (locale == 'en') {
            l = 'http://' + _this.state.data.slug + _this.state.tldType + '/' + postfix;
          } else {
            l = 'http://' + _this.state.data.slug + _this.state.tldType + '/' + locale + '/' + postfix;
          }

          var _link = '<li><a target="_blank" href="' + l + '">' + l + '</a></li>';
    ...
    initFooter: function initFooter$1() {
      initFooter(__('Created by %1$Kenzap%2$. ❤️ Licensed %3$GPL3%4$.', '<a class="text-muted" href="https://kenzap.com/" target="_blank">', '</a>', '<a class="text-muted" href="https://github.com/kenzap/qr-menu" target="_blank">', '</a>'), __('Copyright © %1$ %2$QR menu%3$ Extension', new Date().getFullYear(), '<a class="text-muted" href="https://kenzap.com/qr-code-restaurant-menu-ordering-software-1018140/" target="_blank">', '</a>'));
    }
  };
